            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-600">
                <li className="flex items-center gap-4">
                  ...
                  <span>Jl. Raya Janti, Gg. Arjuna No. 59, Karangjambe, Banguntapan, Bantul, Daerah Istimewa Yogyakarta 55198</span>
                </li>
                <li className="flex items-center gap-4">
                  <Phone className="w-6 h-6 text-red-600" />
                  <div>
                    <p>Paket Tour: 081378641157</p>
                    <p>Sewa Mobil: 085640644321</p>
                  </div>
                </li>
                <li className="flex items-center gap-4">
