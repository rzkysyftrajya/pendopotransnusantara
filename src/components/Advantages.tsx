import { Award, DollarSign, Shield, CheckCircle, Sparkles, Star, Crown, Heart } from "lucide-react";
  ...
  const advantages = [
    {
      ...
      description: "Dedikasi Kami untuk memberikan kualitas dan pelayanan yang terbaik",
    ...
    },
    {
      ...
      description: "Kami siap memberikan solusi terbaik untuk kebutuhan perjalanan Kamu sesuai dengan budget yang Kamu miliki",
    ...
    },
    {
      icon: Shield,
      title: "Terpercaya",
      description: "Sudah berbadan hukum dan dipercaya melayani berbagai instansi, dan perusahaan",
    ...
    },
    {
      icon: CheckCircle,
      title: "Terjamin",
      description: "Kendaraan yang kami miliki sangat memadai demi menjamin keamanan dan kenyamanan Kamu selama di perjalanan",
  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-gradient-to-r from-blue-200/20 to-purple-200/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center gap-2 bg-red-100/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 animate-bounce-in">
            ...
            <span className="text-red-600 font-medium text-sm">Why Choose Us</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Profesionalitas dan keunggulan yang membuat kami terpercaya untuk perjalanan Anda
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {advantages.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="glass-card p-8 md:p-10 text-center group hover:-translate-y-4 transition-all duration-700 cursor-pointer animate-scale-in hover:scale-105 hover:rotate-1"
              ...
              >
                ...
                <div className="relative mb-6">
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-br ${item.gradient} shadow-xl group-hover:shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 animate-float`}
                  >
                    <Icon className="w-10 h-10 md:w-12 md:h-12 text-white animate-pulse" />
                  </div>
                  {/* Glow Effect */}
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${item.gradient} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 animate-glow`}></div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center mt-4">
                    {item.features.map((feature, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-gradient-to-r from-red-50 to-red-100 text-red-600 rounded-full text-xs font-medium border border-red-200 hover:bg-red-100 transition-colors duration-300 animate-fade-in"
                        style={{ animationDelay: `${parseFloat(item.delay) + 0.1 * (idx + 1)}s` }}
                      >
                        {feature}
                      </span>
                    ))}
                ...
                <div className="absolute bottom-4 right-4 w-3 h-3 bg-red-300 rounded-full opacity-30 animate-pulse" style={{ animationDelay: "1s" }}></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="text-center mt-16 animate-fade-in" style={{ animationDelay: "0.8s" }}>
          <p className="text-gray-600 mb-6 text-lg">Siap untuk pengalaman terbaik?</p>
